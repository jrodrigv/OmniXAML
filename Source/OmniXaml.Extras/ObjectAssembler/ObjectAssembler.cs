namespace OmniXaml.Extras.ObjectAssembler
{
    ...
    using Typing;
    using EndMemberCommand = Commands.EndMemberCommand;
    using EndObjectCommand = Commands.EndObjectCommand;
    using GetObjectCommand = Commands.GetObjectCommand;
    using NamespaceDeclarationCommand = Commands.NamespaceDeclarationCommand;
    using StartMemberCommand = Commands.StartMemberCommand;
    using StartObjectCommand = Commands.StartObjectCommand;
    using ValueCommand = Commands.ValueCommand;
    ...
    public class ObjectAssembler : IObjectAssembler
    {
            ...
            IInstanceLifeCycleListener listener)
        {
            ...
            StateCommuter = new StateCommuter(builder, state, typeSource, topDownValueContext, listener);
        ...
        public object Result => StateCommuter.Builder.ToString();
